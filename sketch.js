...
function setup() {
  ...
  back=createSprite(200,200,displayWidth/2-40,displayHeight/2-80);
  back.addImage(backImg);
  back.scale=1;
  back.velocityX=-5;
 
  monkey1 = createSprite(50,350,displayWidth/2-40,displayHeight/2-80 );
  monkey1.addAnimation("monkey",monkey1Img);
 monkey1.scale=0.2;
  ground=createSprite(200,380,displayWidth/3-40,displayHeight/-80);
...
function spawnObstacles() {
  if(frameCount % 160 === 0) {
    var obstacle = createSprite(400,350,displayWidth/2-40,displayHeight/2-80);
...
function spawnFruit() {
  if(frameCount % 90 === 0) {
    var fruita = createSprite(400,200,displayWidth/2-40,displayHeight/2-80);
